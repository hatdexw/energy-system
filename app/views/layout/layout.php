        ...
        <nav class="flex-1">
            <ul class="space-y-2">
                ...
                <?php if (isset($_SESSION['role']) && ($_SESSION['role'] === 'admin' || $_SESSION['role'] === 'user')): ?>
                    ...
                    <li><a href="/energy-system/chamados" class="flex items-center py-2 px-4 rounded-lg text-neutral-200 hover:bg-neutral-700 hover:text-white transition duration-200 ease-in-out group">
